  ...
  return (
    <Flex direction="column" justify="center" align="center" minH="100vh">
      ...
      <Flex direction="column" justify="center" align="center" gap={10}>
        <ProjectCard title="Blackjack" skills={["TypeScript", "React", "Framer Motion"]}>
        ...
        <ProjectCard title="Blobboi" skills={["C#", "Unity Engine"]}>
        ...
        <ProjectCard title="BetterVoting" skills={["TypeScript", "discord.js"]}>
        ...
        <ProjectCard title="Unamed mobile app" skills={["C#", "Unity Engine", "Firebase"]}>
        ...
        <ProjectCard title="This website" skills={["NextJS", "Chakra UI"]}>
